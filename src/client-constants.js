...
export const AGENT_TYPES = ['sisyphus', 'hermes', 'explore', 'librarian', 'looker', 'hephaestus', 'prometheus', 'oracle', 'apelles']
...
// 工种徽章色板（面板 chip / 配置卡共用）：深色底上取中亮度、彼此可辨的克制色
...
export const INTENT_LABELS = { explore: '检索', read_doc: '查文档', look_image: '看图', replan: '请求换工种', execute: '请求代执行', ask_user: '请求问用户', consult: '方案冲突请示' }
